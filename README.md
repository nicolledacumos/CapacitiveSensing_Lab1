...
## Sensor Calibration
I used this to find the thresholds for each wire in my slider. Because I was having some trouble printing all three values in a way that was easy for me to see, I just changed the touch_pin value every time I ran the code and noted it in my journal. I referred back to this code every time I would have an issue with my touch sensors in the other sections, which helped me detect if I had a wire in the wrong spot.
